import { newPedido } from '../services/order.service.js';
...
export const newOrder = async (req, res) => {
  const { empresa_id, dataPedido } = req.body;

  console.log('Ejecutando Crear Pedido.');
  console.log('----------------------------------------');

  try {
    if (!empresa_id || !dataPedido) {
      return res.status(400).json({
        message: 'Parámetros incompletos',
      });
    }

    const data = await newPedido(empresa_id, dataPedido);
...
//   const { empresa_id, mesa_id, activo } = req.body;

//   console.log('Ejecutando (In)activar mesa.');
//   console.log('----------------------------------------');

//   try {
//     if (!empresa_id || !mesa_id || activo === undefined) {
//       return res.status(400).json({
//         message: 'Parámetros incompletos',
//       });
//     }

//     const mesa = await activeMesa(empresa_id, mesa_id, activo);
...
//   const { empresa_id, dataTable } = req.body;

//   try {
//     if (!empresa_id || !dataTable) {
//       return res.status(400).json({
//         message: 'Parámetros incompletos',
//       });
//     }
...
//     const mesa = await updateMesa(empresa_id, dataTable);
...
//   const { empresa_id, mesa_id } = req.body;

//   try {
//     if (!empresa_id || !mesa_id) {
//       return res.status(400).json({
//         message: 'Parámetros incompletos',
//       });
//     }
...
//     const mesa = await deleteMesa(empresa_id, mesa_id);
